...
public interface Analysis extends Switch
{
    ...
    void caseAPlusOpOp(APlusOpOp node);
    void caseAMinusOpOp(AMinusOpOp node);
    void caseAMultOpOp(AMultOpOp node);
    void caseADivOpOp(ADivOpOp node);
    void caseAModOpOp(AModOpOp node);
    ...
    void caseAAnd1Boolop(AAnd1Boolop node);
    void caseAOr1Boolop(AOr1Boolop node);
