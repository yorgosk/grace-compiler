...
public final class AIfMatchedElseUnmatchedUnmatched extends PUnmatched
{
    private TIf _if_;
    ...
    public AIfMatchedElseUnmatchedUnmatched()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIfMatchedElseUnmatchedUnmatched(
            cloneNode(this._if_),
    ...
    {
        ((Analysis) sw).caseAIfMatchedElseUnmatchedUnmatched(this);
    }
